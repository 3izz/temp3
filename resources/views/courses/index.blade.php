...
<div style="font-family: 'Poppins', sans-serif; background-color: #f4f6f9; min-height: 100vh; padding: 40px 20px;">
    ...
    <div class="container" style="max-width: 1400px; margin: 0 auto;">
        ...
        {{-- تم إزالة position: sticky من هنا --}}
        ...
        {{-- تم إزالة position: sticky و top و z-index من هنا --}}
            ...
            @forelse($courses as $course)
                <div class="card" style="background-color: #fff; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 20px rgba(0,0,0,0.05); display: flex; flex-direction: column; transition: transform 0.2s;">
                    ...
                    <div class="card-body" style="padding: 20px 20px 25px 20px; text-align: center; display: flex; flex-direction: column; flex-grow: 1;">
                        ...
                        <h3 class="card-title" style="font-size: 1.2rem; margin: 0 0 10px 0; color: #333; font-weight: 600;">{{ $course->title }}</h3>
                        ...
                        <div class="card-actions" style="display: flex; justify-content: space-between; gap: 10px; margin-bottom: 15px;">
                            <a href="{{ route('courses.show', $course) }}" style="flex: 1; background: #fff; border: 1px solid #ffccb3; border-radius: 6px; padding: 8px 0; color: #555; font-size: 0.75rem; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 5px;">
                                <i class="fa-solid fa-desktop"></i> Start Demo
                            </a>
                            <a href="{{ route('pricing.index') }}" style="flex: 1; background: #fff; border: 1px solid #ffccb3; border-radius: 6px; padding: 8px 0; color: #555; font-size: 0.75rem; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 5px;">
