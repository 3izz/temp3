    ...
    <div class="chat-container">
        <div class="chat-header">
            <div class="user-info">
                ...
                <div>
                    <h3 style="margin:0; font-size:15px;"><?php echo e($otherUser->name); ?></h3>
...
function chatApp() {
    return {
        authId: <?php echo e((int) auth()->id()); ?>,
        otherUserId: <?php echo e((int) $otherUser->id); ?>,
        messages: [],
        newMessage: '',
        loading: true,
        sending: false,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\blog2\resources\views/chat/show.blade.php ENDPATH**/ ?>